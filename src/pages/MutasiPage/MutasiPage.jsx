   ...
   const columns = useMemo(() => {
        const baseColumns = [
            ...
            { 
                ...
                align: 'right', 
                width: 200, 
                render: (saldo) => (saldo != null) ? currencyFormatter(saldo) : <Text type="secondary">-</Text>, 
                ...
                render: (_, record) => (
                    <Space size="small"> 
                        <Tooltip title={record.buktiUrl ? "Lihat Bukti" : "Tidak ada bukti"}>
                            <Button type="text" size="small" icon={<EyeOutlined />} onClick={() => handleViewProof(record.buktiUrl)} disabled={!record.buktiUrl} style={{ color: '#1890ff' }} />
                        </Tooltip> 
                        <Tooltip title="Edit Transaksi">
                            <Button type="text" size="small" icon={<EditOutlined />} onClick={() => handleEdit(record)} style={{ color: '#faad14' }} />
                        </Tooltip> 
                    </Space>
                ) 
            },
